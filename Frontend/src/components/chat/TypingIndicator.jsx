...
const TypingIndicator = () => {
  return (
    <div className="flex gap-4 items-end w-full max-w-3xl mb-8 animate-in fade-in duration-300">
      ...
      <div className="bg-white dark:bg-[#1A1C1E] border border-[#C3C6D7] dark:border-gray-800 flex gap-2 items-center px-4 py-3 rounded-bl-2xl rounded-br-2xl rounded-tr-2xl shadow-sm">
