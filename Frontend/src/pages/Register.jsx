  ...
  return (
    <div className="min-h-screen w-full bg-[#f8f9fb] font-inter flex flex-col relative overflow-x-hidden">
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-6 mt-14 lg:p-12 space-y-6 origin-top scale-[0.7] md:scale-[0.75] lg:scale-[0.8] transition-transform duration-500">
        {error && (
          <div className="w-full max-w-[896px] bg-[#ffdad6] border border-[#ba1a1a] flex gap-4 items-center px-6 py-4 relative rounded-lg shadow-[0px_20px_25px_-5px_rgba(0,0,0,0.1),0px_8px_10px_-6px_rgba(0,0,0,0.1)] animate-in fade-in slide-in-from-top-2 duration-300">
          ...
          <div className="flex-1 p-8 lg:p-10 space-y-6">
            ...
            <form onSubmit={handleRegister} className="space-y-4">
              ...
              <button 
                type="submit"
                disabled={loading}
                className="w-full bg-[#2563eb] text-white py-4 rounded-md font-semibold text-sm flex items-center justify-center gap-2 hover:bg-[#1d4ed8] active:scale-[0.99] transition-all shadow-[0px_4px_12px_rgba(37,99,235,0.1)] pt-4 mt-2 disabled:opacity-60 disabled:cursor-not-allowed"
              >
                {loading ? 'Memproses...' : 'Create an Account'}
