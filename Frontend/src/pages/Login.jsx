...
const Login = () => {
  ...
  const handleLogin = (e) => {
    ...
    // Simulasi login (admin@test.com / admin123)
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-6 lg:p-12 relative">
        ...
        <div className="bg-white border border-[#e1e2e4] shadow-[0px_12px_24px_rgba(17,24,39,0.05)] rounded-2xl p-8 lg:p-10 w-full max-w-[448px] relative z-10 space-y-8">
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            <button 
              type="submit" 
              className="w-full bg-[#2563eb] text-[#eeefff] py-4 rounded-lg font-bold text-[15px] flex items-center justify-center gap-2 hover:bg-[#1d4ed8] active:scale-[0.98] transition-all shadow-[0px_4px_12px_rgba(37,99,235,0.2)]"
            >
              Enter
